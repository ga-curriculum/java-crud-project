...
Kick off your project with planning. For more details and the specific requirements, see the [[tktk Module Name] Deliverables](../deliverables/README.md).
...
Create the public GitHub repo that you'll use for the project. See the [[tktk Module Name] Deliverables](../deliverables/README.md) for more details.
...
Deploy your project to the internet following the included deployment guide and submit a URL for your deployed app. For more details, see the [[tktk Module Name] Deliverables](../deliverables/README.md).
