...
This is the repo for an individual Java CRUD Project. It includes:

- Java CRUD Project Journey
- Java CRUD Project Requirements and Guidance
- Java CRUD Project Deliverables [students submit URLs for their project planning materials, a GitHub repo, and a deployed app through the duration of the project. This can be customized - see the **Customizing deliverables** section]
- Java CRUD Project Feedback [in Canvas only]
