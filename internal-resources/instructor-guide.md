...
tktk Ensure this document doesn't directly conflict with how you've structured the project documentation and rubric. It's possible some items here won't make sense after building out the project docs.
...
- [tktk Module Name] Requirements and Guidance
- [tktk Module Name] Deliverables [students submit URLs for their project planning materials, a GitHub repo, and a deployed app through the duration of the project. This can be customized - see the **Customizing deliverables** section]
- [tktk Module Name] Feedback [in Canvas only]

## Customizing your project delivery

Customize how you deliver project content by adding to the existing project documentation. Existing content should not be changed, but you may remove it if there are direct conflicts with your customizations. Ensure you're still providing students with enough background information to successfully build their projects if you do this.

You should not add, remove, or alter any project requirements.

The [tktk Module Name] Requirements and Guidance page provides some basic background information for the project in the **Guidance** section. Sensible defaults are provided here, but you may want to add some details on top of what this document provides to match how you'd like to frame the project for your students.
...
You can also make changes to the planning materials students submit and the app they use to build them. For this project, students will develop their planning materials using tktk by default. If you'd prefer something different, you must create a new Project Planning Deliverable document to replace the existing one.
